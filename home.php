...
<body>
     ...
     <form action="upload.php" method="POST"></form>   
        <div class="newPost">
          <span>
            ...
            <input type="text" placeholder="Escreva algo" id="content">
          </span>
          <hr/>
          <span class="action">
            <label class="customUploadFile">
              <input type="file" id="foto" id="imageUpload">Adicionar foto</label>
  ...
  <script>
    $("#publicar").click(function(){
      ...
      var url = $("#foto");
      console.log(document.querySelector(".modalDelete"))
      if(content === ""){
        document.querySelector(".inVisible").className = "modalDelete Visible";
       
      }
    });
    $("#btn-m").click(function() {
      document.querySelector(".Visible").style.visibility = "hidden";
      document.querySelector(".Visible").className = "modalDelete inVisible";
    })
  </script>
</body>
</html>